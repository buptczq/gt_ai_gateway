...
- **Responses API 粘性路由 (Sticky Routing)**：针对 OpenAI 官方实验性质的 Responses API 极其严苛的上下文路由限制，网关能够在协议层智能重写 `prompt_cache_key`，为多轮对话赋予强粘性特征，从而突破限制并最大化缓存命中率，让多轮对话和复杂场景也能完美享受 Responses API 的低成本和高响应速度优势。
